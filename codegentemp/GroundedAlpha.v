// ======================================================================
// GroundedAlpha.v generated from TopDesign.cysch
// 02/16/2024 at 19:47
...
module SCB_UART_PDL_v2_0_0 (
	...
	cy_clock_v1_0
		#(.id("20d5cf26-0577-4e92-b902-39babbc7933a/b68e5b9d-7828-482d-a282-930f990e3b3e"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_mxs40_gpio_v1_0
		#(.id("20d5cf26-0577-4e92-b902-39babbc7933a/65f3af6c-759b-4ccb-8c66-5c95ba1f5f4f"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("20d5cf26-0577-4e92-b902-39babbc7933a/b7e8018e-1ef7-49c0-b5a5-61641a03e31c"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("1"),
...
module SCB_I2C_PDL_v2_0_1 (
	...
	cy_clock_v1_0
		#(.id("953190cf-a036-43d3-b47a-c9cc7125a866/b68e5b9d-7828-482d-a282-930f990e3b3e"),
		  .source_clock_id(""),
		  .divisor(0),
...
module Scan_ADC_v3_10_2 (
    ...
    electrical [2:0] Net_340;
    electrical [2:0] Net_339;

    cy_mxs40_sarmux_v1_0 SARMUX (
        .cmn_neg(Net_21[0:0]),
        .muxin_minus(Net_340[2:0]),
        .muxin_plus(Net_339[2:0]),
        .muxout_minus(sarmuxOutMinus),
        .muxout_plus(sarmuxOutPlus));
    defparam SARMUX.cmn_neg_width = 1;
    defparam SARMUX.input_mode = "010";
    defparam SARMUX.muxin_width = 3;


	cy_clock_v1_0
		#(.id("ee67e59c-1168-4cc4-b27e-7cb6f8b98057/f7143d07-534d-4542-813a-8bb23ceb1ae9"),
...
module top ;
	...
	cy_mxs40_gpio_v1_0
		#(.id("4b9a2b9c-ebac-4aad-afc0-1f5d01d85373"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("4"),
		  .ibuf_enabled("1"),
	...
	wire [0:0] tmpFB_0__MW_net;
	wire [0:0] tmpIO_0__MW_net;
	electrical [0:0] tmpSIOVREF__MW_net;

	cy_mxs40_gpio_v1_0
		#(.id("a021e1aa-fdc4-4ad2-b776-b7b8c994507e"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
		...
		MW
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__MW_net[0:0]}),
		  .io({tmpIO_0__MW_net[0:0]}),
		  .siovref(tmpSIOVREF__MW_net));
	...
	wire [0:0] tmpFB_0__VMudWatt_net;
	wire [0:0] tmpIO_0__VMudWatt_net;
	electrical [0:0] tmpSIOVREF__VMudWatt_net;

	cy_mxs40_gpio_v1_0
		#(.id("b713ff56-2792-4891-a5ad-39c9cf2492cc"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
		...
		VMudWatt
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__VMudWatt_net[0:0]}),
		  .analog({Net_92}),
		  .io({tmpIO_0__VMudWatt_net[0:0]}),
		  .siovref(tmpSIOVREF__VMudWatt_net));


	wire [0:0] tmpFB_0__VWheatStone_net;
	wire [0:0] tmpIO_0__VWheatStone_net;
	electrical [0:0] tmpSIOVREF__VWheatStone_net;

	cy_mxs40_gpio_v1_0
		#(.id("65ec5672-035d-4fff-ae9d-94805bd21d67"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
		...
		VWheatStone
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__VWheatStone_net[0:0]}),
		  .analog({Net_91}),
		  .io({tmpIO_0__VWheatStone_net[0:0]}),
		  .siovref(tmpSIOVREF__VWheatStone_net));


	wire [0:0] tmpFB_0__VWS_net;
	wire [0:0] tmpIO_0__VWS_net;
	electrical [0:0] tmpSIOVREF__VWS_net;

	cy_mxs40_gpio_v1_0
		#(.id("548206c8-3519-4ffe-a3f9-54297c146cb1"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("0"),
		...
		VWS
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__VWS_net[0:0]}),
		  .analog({Net_108}),
		  .io({tmpIO_0__VWS_net[0:0]}),
		  .siovref(tmpSIOVREF__VWS_net));
